class Product < ActiveRecord::Base
	attr_accessible :productname, :description, :category, :quantity, :maxprice, :location, :deadline, :user_id, :buy_id, :status, :pic, :pic_file_name, :pic_content_type, :pic_file_size, :pic_updated_at
